...
def check_aliens_bullets_collision(ai_settings, screen, stats , sb, ship, aliens, bullets):
    """respned to alines/bullets collision"""
    ...
    if len(aliens) == 0:
        # when finshing --> destroy existing bullets and create new fleet
        bullets.empty()
...
def get_number_rows(ai_settings, ship_height, alien_height):
    abailable_space_y = (ai_settings.screen_height - (3 * alien_height) - ship_height)
    number_rows = int(abailable_space_y / (2*alien_height))
    return number_rows
